...
<div class="main-header">
    ...
    <p>Tác giả: Đoàn Văn Dũng - Trường Tiểu học Hùng An - ĐT:0912390581</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Đoàn Văn Dũng  - Trường Tiểu học Hùng An - ĐT: 0912390581</div>", unsafe_allow_html=True)
